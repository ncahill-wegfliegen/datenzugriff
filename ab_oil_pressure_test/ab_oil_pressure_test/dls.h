...
NHILL_DZG_ABOPT_PORT_FUNCTION bool operator==( const Dls& a, const Dls& b );
NHILL_DZG_ABOPT_PORT_FUNCTION bool operator!=( const Dls& a, const Dls& b );
...
NHILL_DZG_ABOPT_PORT_FUNCTION char to_char( Dls::Rgd rgd );
NHILL_DZG_ABOPT_PORT_FUNCTION Dls::Rgd to_dls_range_direction( char c );
